                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-styles">
                    <li>
                        <form action="{{route('admin.set-theme')}}" method="POST">
                            ...
                            <button type="submit" class="dropdown-item">
                                <span class="align-middle"> <i class="fa-light fa-brightness-low fa-xl ml-2"></i>روشن</span>
                            </button>
                        </form>
                    </li>
                    <li>
                        <form action="{{route('admin.set-theme')}}" method="POST">
                            ...
                            <button type="submit" class="dropdown-item" data-theme="dark">
                                <span class="align-middle"> <i class="fa-sharp fa-light fa-moon-stars fa-lg ml-2"></i> تاریک</span>
                            </button>
                        </form>
                    ...
                    <li>
                        <a class="dropdown-item" href="javascript:void(0);" data-theme="system">
                            <span class="align-middle"><i class="fa-light fa-desktop fa-lg ml-2"></i>سیستم</span>
                        </a>
                    </li>
                </ul>
            </li>
