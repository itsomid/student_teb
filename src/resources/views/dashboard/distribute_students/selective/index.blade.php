...
@section('content')
    <div class="row">
        <form class="card" action="{{route('admin.selective.students.distribution.distribute')}}" method="post">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="support_ids">پخش بین:</label>
                            <select class="select2 form-select" id="support_ids" name="support_ids[]" multiple>
                                @foreach($supports as $support)
