                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="name" id="name" class="form-control" placeholder="نام را وارد کنید."
                                value="{{ old('name') ?? $course->product->name }}" required>
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="original_price">قیمت (ریال):</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mt-3">
                            <label class="form-label" for="off_price">قیمت حراجی با اعمال کد تخفیف (ریال):</label>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="select2 form-select" id="product_type_id" name="product_type_id">
                                ...
                                @foreach ($types as $key => $value)
                                    <option value="{{ $key }}"
                                        {{ $course->product->product_type_id == $key ? 'selected' : null }}>
                                        {{ $value }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <x-admin-selection-component input-name="user_id" role="teacher"
                    ...
                    @if ($course->product->img_filename)
                        <div class="col-md-3 mb-1">
                            <div class="form-group mt-3">
                            ...
                            <select id="categories" class="select2 text-capitalize mb-md-0 " name="categories[]"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        {{ in_array($category->id, collect($course->product->categories)->pluck('id')->toArray()) ? 'selected' : null }}>
                    ...
                    <div class="col-md-12 mt3">
                        <div class="form-group mt-3">
                            <div class="form-group mt-3">
                                ...
                                <x-tinymce-editor selector="description" :value="$course->product->description" />
                                @error('description')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="form-group">
                            ...
                            <x-tinymce-editor selector="about_course" :value="$course->about_course" />
                            @error('about_course')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3 mb-1">
                        <div class="form-group mt-2">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input" value="1" type="checkbox" role="switch"
                                    id="has_installment" name="has_installment"
                                    {{ $course->product->has_installment == 1 ? 'checked' : '' }}>
                                @error('has_installment')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-2">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input" type="checkbox" value="1" role="switch"
                                    id="qa_status" name="qa_status" {{ $course->qa_status == 1 ? 'checked' : '' }}>
                                @error('show_in_list')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group mt-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number"
                                    value="{{ $course->product->installment_count }}" id="installment_count"
                                    name="installment_count" placeholder="پیش فرض: ۴">
                    ...
                    <div class="col-md-3 mb-1">
                        <div class="form-group mt-2">
                            <div class="form-group">
                                <label class="form-label" for="first_installment_ratio">میزان پرداختی اولیه (بصورت
                                    درصد
                                    %):</label>
                                <input name="first_installment_ratio" type="number" id="first_installment_ratio"
                                    max="100" min="0"
                                    value="{{ $course->product->first_installment_ratio }}" class="form-control"
                                    placeholder="پیش فرض ۳۳">
                                @error('first_installment_ratio')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-2">
                            <div class="form-group">
                                <label class="form-label" for="first_installment_amount">پرداختی اولیه (بصورت
                                    مبلغ):</label>
                                <input name="first_installment_amount" type="text" id="first_installment_amount"
                                    class="form-control numeral-mask" placeholder="پیش فرض: 1000000"
                                    value="{{ $course->product->first_installment_amount }}">
                                @error('first_installment_amount')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-2">
                            <div class="form-group">
                                ...
                                <input name="final_installment_date" type="text" id="final_installment_date"
                                    ...
                                    value="{{ $course->product->final_installment_date() }}" autocomplete="off"
                                    placeholder="زمان سر رسید قسط آخر را وارد کنید.">
                                @error('final_installment_date')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mt-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="subscription_start_at" class="form-control"
                                name="subscription_start_at" placeholder="زمان شروع دوره اشتراکی را وارد کنید"
                                data-jdp
                    ...
                    <div class="col-md-6 mt-4">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="expiration_duration" id="expiration_duration"
                                class="form-control" placeholder="مدت زمان اشتراک"
                    ...
                    <div class="col-md-12">
                        <div class="form-group mt-3"><label for="introduce_video">لینک ویديو آفلاین (iframe):</label>
                            <input type="text" name="introduce_video" id="introduce_video" class="form-control"
                                placeholder="aparat,..." value="{{ $course->introduce_video }}">
                        </div>
                    </div>
                    <hr class="mt-3">
                    ...
                    <div class="col-md-6 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control" id="start_date" name="start_date"
                                placeholder="زمان شروع دوره را وارد کنید" autocomplete="off"
                    ...
                    <div class="col-md-6 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <select id="holding_days1" class="form-select text-capitalize mb-md-0 "
                                ...
                                <option {{ $course->product->options['holding_days1'] == 1 ? 'selected' : null }}
                                    value="1">
                                    شنبه
                                </option>
                                <option {{ $course->product->options['holding_days1'] == 2 ? 'selected' : null }}
                                    value="2">
                                    یکشنبه
                                </option>
                                <option {{ $course->product->options['holding_days1'] == 3 ? 'selected' : null }}
                                    value="3">
                                    دوشنبه
                                </option>
                                <option {{ $course->product->options['holding_days1'] == 4 ? 'selected' : null }}
                                    value="4">
                                    سه‌شنبه
                                </option>
                                <option {{ $course->product->options['holding_days1'] == 5 ? 'selected' : null }}
                                    value="5">
                                    چهارشنبه
                                </option>
                                <option {{ $course->product->options['holding_days1'] == 6 ? 'selected' : null }}
                                    value="6">
                                    پنج‌شنبه
                                </option>
                                <option {{ $course->product->options['holding_days1'] == 7 ? 'selected' : null }}
                                    value="7">
                                    جمعه
                                </option>
                            </select>
                            @error('options[holding_days1]')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <input type="time" name="options[holding_hours1][]" class="form-control"
                                id="holding_hours1" placeholder="ساعت برگزاری جلسه اول"
                    ...
                    <div class="col-md-6 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <select id="holding_days2" class="form-select text-capitalize mb-md-0 "
                                ...
                                <option value="0">انتخاب نشده</option>
                                <option {{ $course->product->options['holding_days2'] == 1 ? 'selected' : null }}
                                    value="1">
                                    شنبه
                                </option>
                                <option {{ $course->product->options['holding_days2'] == 2 ? 'selected' : null }}
                                    value="2">
                                    یکشنبه
                                </option>
                                <option {{ $course->product->options['holding_days2'] == 3 ? 'selected' : null }}
                                    value="3">
                                    دوشنبه
                                </option>
                                <option {{ $course->product->options['holding_days2'] == 4 ? 'selected' : null }}
                                    value="4">
                                    سه‌شنبه
                                </option>
                                <option {{ $course->product->options['holding_days2'] == 5 ? 'selected' : null }}
                                    value="5">
                                    چهارشنبه
                                </option>
                                <option {{ $course->product->options['holding_days2'] == 6 ? 'selected' : null }}
                                    value="6">
                                    پنج‌شنبه
                                </option>
                                <option {{ $course->product->options['holding_days2'] == 7 ? 'selected' : null }}
                                    value="7">
                                    جمعه
                                </option>
                            </select>
                    ...
                    <div class="col-md-3 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <input type="time" name="options[holding_hours2][]" class="form-control"
                                id="holding_hours2" placeholder="ساعت برگزاری جلسه دوم"
                    ...
                    <div class="col-md-6 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <select id="holding_days3" class="form-select text-capitalize mb-md-0 "
                                ...
                                <option value="0">انتخاب نشده</option>
                                <option {{ $course->product->options['holding_days3'] == 1 ? 'selected' : null }}
                                    value="1">
                                    شنبه
                                </option>
                                <option {{ $course->product->options['holding_days3'] == 2 ? 'selected' : null }}
                                    value="2">
                                    یکشنبه
                                </option>
                                <option {{ $course->product->options['holding_days3'] == 3 ? 'selected' : null }}
                                    value="3">
                                    دوشنبه
                                </option>
                                <option {{ $course->product->options['holding_days3'] == 4 ? 'selected' : null }}
                                    value="4">
                                    سه‌شنبه
                                </option>
                                <option {{ $course->product->options['holding_days3'] == 5 ? 'selected' : null }}
                                    value="5">
                                    چهارشنبه
                                </option>
                                <option {{ $course->product->options['holding_days3'] == 6 ? 'selected' : null }}
                                    value="6">
                                    پنج‌شنبه
                                </option>
                                <option {{ $course->product->options['holding_days3'] == 7 ? 'selected' : null }}
                                    value="7">
                                    جمعه
                                </option>
                            </select>
                    ...
                    <div class="col-md-3 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <input type="time" name="options[holding_hours3][]" class="form-control"
                                id="holding_hours3" placeholder="ساعت برگزاری جلسه سوم"
...
@vite(['resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/js/forms-selects.js', 'resources/assets/js/jalalidatepicker.js', 'resources/assets/vendor/libs/cleavejs/cleave.js', 'resources/assets/js/forms-extras.js', 'resources/assets/vendor/libs/tinymce/tinymce.js'])
@endsection
