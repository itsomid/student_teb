                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="select2 form-select" id="product_type_id" name="product_type_id">
                                ...
                                @foreach($types as $key => $value)
                                    <option
                                        value="{{$key}}" {{$course->product->product_type_id == $key ? 'selected' : null}}>{{$value}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group mt-2">
                            <div class="form-group">
                                <label class="form-label" for="first_installment_amount">پرداختی اولیه (بصورت
                                    مبلغ):</label>
                                <input name="first_installment_amount" type="text"
                        ...
                        <div class="form-group mt-2">
                            <div class="form-group">
                                ...
                                <input name="final_installment_date"
                                       ...
                                       class="form-control"
                                       data-jdp
                                       value="{{$course->product->final_installment_date()}}"
                                       autocomplete="off"
                    ...
                    <div class="col-md-6 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <select id="holding_days1" class="form-select text-capitalize mb-md-0 "
                                ...
                                <option
                                    {{$course->product->options['holding_days1'] == 1 ? 'selected' : null}} value="1">
                                    شنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days1'] == 2 ? 'selected' : null}} value="2">
                                    یکشنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days1'] == 3 ? 'selected' : null}} value="3">
                                    دوشنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days1'] == 4 ? 'selected' : null}} value="4">
                                    سه‌شنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days1'] == 5 ? 'selected' : null}} value="5">
                                    چهارشنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days1'] == 6 ? 'selected' : null}} value="6">
                                    پنج‌شنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days1'] == 7 ? 'selected' : null}} value="7">
                                    جمعه
                                </option>
                            </select>
                    ...
                    <div class="col-md-6 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <select id="holding_days2" class="form-select text-capitalize mb-md-0 "
                                ...
                                <option value="0">انتخاب نشده</option>
                                <option
                                    {{$course->product->options['holding_days2'] == 1 ? 'selected' : null}} value="1">
                                    شنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days2'] == 2 ? 'selected' : null}} value="2">
                                    یکشنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days2'] == 3 ? 'selected' : null}} value="3">
                                    دوشنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days2'] == 4 ? 'selected' : null}} value="4">
                                    سه‌شنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days2'] == 5 ? 'selected' : null}} value="5">
                                    چهارشنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days2'] == 6 ? 'selected' : null}} value="6">
                                    پنج‌شنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days2'] == 7 ? 'selected' : null}} value="7">
                                    جمعه
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-6 mb-1">
                        <div class="form-group mt-3">
                            ...
                            <select id="holding_days3" class="form-select text-capitalize mb-md-0 "
                                ...
                                <option value="0">انتخاب نشده</option>
                                <option
                                    {{$course->product->options['holding_days3'] == 1 ? 'selected' : null}} value="1">
                                    شنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days3'] == 2 ? 'selected' : null}} value="2">
                                    یکشنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days3'] == 3 ? 'selected' : null}} value="3">
                                    دوشنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days3'] == 4 ? 'selected' : null}} value="4">
                                    سه‌شنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days3'] == 5 ? 'selected' : null}} value="5">
                                    چهارشنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days3'] == 6 ? 'selected' : null}} value="6">
                                    پنج‌شنبه
                                </option>
                                <option
                                    {{$course->product->options['holding_days3'] == 7 ? 'selected' : null}} value="7">
                                    جمعه
                                </option>
                            </select>
                        </div>
