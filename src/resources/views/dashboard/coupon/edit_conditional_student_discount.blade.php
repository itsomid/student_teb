...
@section('content')
    ...
    <form  action="{{route('admin.coupons.update-conditional-student-discount', $coupon)}}" method="post">
        @csrf
        @method('PATCH')

        <div class="card my-4 my-3">
            <div class="card-body">
                <h5 class="card-title"> ویرایش کد تخفیف شرطی</h5>
                <div class="row">
                    <div class="col-md-12 mt-3" id="coupon-code-field-group">
                        <div class="form-group ">
                            <label for="coupon">کد تخفیف:</label>
                            <input name="coupon" type="text" id="coupon" class="form-control" placeholder="کد تخفیف را وارد کنید." value="{{old('coupon') ?? $coupon->coupon}}" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mt-3">
                            ...
                            <input name="discount_amount" type="text" id="discount_amount" class="form-control" placeholder="مبلغ تخفیف  را وارد کنید." value="{{old('discount_amount') ?? $coupon->discount_amount}}" number-separator="true" autocomplete="off">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 p-6">
                        ...
                        <label class="switch">
                            <input type="checkbox" class="switch-input" name="for_last_year_students" @checked(old('for_last_year_students', $coupon->conditions->for_last_year_students))/>
                    ...
                    <div class="col-md-9">
                        <div class="form-group ">
                            ...
                            <input name="last_year_minimum_purchase" type="number" id="last_year_minimum_purchase" class="form-control" placeholder="حداقل  تعداد خرید سال گذشته" value="{{old('last_year_minimum_purchase') ?? $coupon->conditions->last_year_minimum_purchase}}" autocomplete="off">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="select2 form-select" id="purchases_status" name="purchases_status">
                                <option value="all"              @selected(old('purchases_status', $coupon->conditions->purchases_status) == "all" )>همه</option>
                                <option value="once_or_more"     @selected(old('purchases_status', $coupon->conditions->purchases_status) == "once_or_more" )>حداقل یک خرید داشته اند</option>
                                <option value="with_no_purchase" @selected(old('purchases_status', $coupon->conditions->purchases_status) == "with_no_purchase" )>تاکنون خریدی نداشته اند</option>
                            </select>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group ">
                            ...
                            <input name="cart_items_count" type="number" id="cart_items_count" class="form-control" placeholder="حداقل تعداد درس داخل سبد خرید" value="{{old('cart_items_count') ?? $coupon->conditions->cart_items_count}}" autocomplete="off">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            @error('specified_cart_items')<small class="text-danger">{{$message}}</small>@enderror
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="grade[]"
                                ...
                                @foreach(\App\Data\Grades::get() as $key=>$grade)
                                    <option @selected(in_array($key, $coupon->conditions->grade))  value="{{$key}}">
                                        {{$grade}}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="field_of_study[]"
                                ...
                                @foreach(\App\Data\FieldOfStudy::get() as $key=>$field)
                                    <option  @selected(in_array($key, $coupon->conditions->field_of_study))  value="{{$key}}">
                                        {{$field}}
                                    </option>
                                @endforeach
                            </select>
