import {APP_DESCRIPTION, APP_NAME} from "../constants/app.const";

export const MANIFEST = {
    name: APP_NAME,
    short_name: APP_NAME,
    description: 'پنل دانش آموز کلاسینو',
    start_url: '.',
    display: 'standalone',
    theme_color: '#036af5',
    background_color: '#036af5',
    orientation: 'any',
    status_bar: '#036af5',
    splash: {
        '640x1136': '/icons/android-chrome-192x192.png',
        '750x1334': '/icons/android-chrome-192x192.png',
        '828x1792': '/icons/android-chrome-192x192.png',
        '1125x2436': '/icons/android-chrome-192x192.png',
        '1242x2208': '/icons/android-chrome-192x192.png',
        '1242x2688': '/icons/android-chrome-192x192.png',
        '1536x2048': '/icons/android-chrome-192x192.png',
        '1668x2224': '/icons/android-chrome-192x192.png',
        '1668x2388': '/icons/android-chrome-192x192.png',
        '2048x2732': '/icons/android-chrome-192x192.png'
    },
    "icons": [
        {
